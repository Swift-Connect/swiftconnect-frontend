...
const Sidepane = () => {
  ...
  return (
    <div className='w-64 bg-[#FAFAFA] shadow-lg fixed flex flex-col justify-between'>
      {/* Header */}
      <div>
      ...
      {/* User Info Box */}
      <div className='mt-6 bg-[#00007c55] p-6 h-full rounded-lg shadow-md mx-4'>
        {user ? (
          <div>
            <div className='flex items-center mt-4'>
              ...
              <div className='flex flex-col'>
                <span className='text-sm text-[#0E1318]'>
                  {user?.username || '--'}
                </span>
