...
export default function Header({ setHideSideMenu }) {
  return (
    <header className="flex max-md-[400px]:w-full justify-between items-center  bg-white py-4 px-8 max-md-[400px]:justify-start max-md-[400px]:px-2 header-shadow max-md-[400px]:gap-4">
