...
const SignupPage = () => {
  ...
  const handleStep1Submit = async (e) => {
    ...
    try {
      const response = await fetch(`${BASE_URL ? `${BASE_URL}/users/get-otp/`: 'http://localhost:8000/users/get-otp/'}`, {
        method: 'POST',
        headers: {
  ...
  const handleStep2Submit = async (e) => {
    ...
    try {
      const response = await fetch(BASE_URL ? `${BASE_URL}/users/verify-otp/` : "http://localhost:8000/users/verify-otp/", {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const handleStep3Submit = async (e) => {
    ...
    try {
      const response = await fetch(`http://localhost:8000/users/complete-profile/${user_id}/`, {
        method: 'PATCH',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const handleTxnPinSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`${BASE_URL ? `${BASE_URL}/users/create-transaction-pin/` : 'http://localhost:8000/users/create-transaction-pin/'}`, {
        method: 'POST',
        headers: {
