...
const Page = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const loginData = {
      [authMode === "mobile" ? "phone_number" : "email"]:
        authMode === "mobile" ? `${selectedCountry.code}${phoneNumber}` : email,
      password,
    };
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            >
              ...
              {authMode === "mobile" ? (
                ...
                <input
                  ...
                  className={`flex-1 border-0 p-3 focus:ring-0 rounded-xl focus:outline-none w-fit ${
          ...
          <div className="flex gap-4">
            <button
              type="button"
              onClick={() =>
                setAuthMode(authMode === "mobile" ? "email" : "mobile")
              }
              disabled={isLoading}
